    ...
    <Cartprod />
     <section className="flex lg:justify-center  ">
        <div className="flex flex-col lg:justify-center lg:items-center w-screen lg:w-[832px] h-[166px]" style={{ gap: '40px' }}>
          <h2 className="font-medium text-2xl md:text-3xl lg:text-4xl items-center text-center capitalize" style={{ fontFamily: 'poppins', lineHeight: '58px', letterSpacing: '-1px', color: '#000000', fontWeight: '500' }}>
            Check out
          </h2> 
